...
module.exports = function bus(conn) {
    ...
    this.connection.on('message', function(msg) {
       if (msg.type == constants.messageType.methodReturn || msg.type == constants.messageType.error) {
           ...
           // TODO: check there is no collision possible
           var signalFullName = [/*msg.destination, */ msg.path, msg['interface'], msg.member].join('#');
           self.signals.emit(signalFullName, msg.body, msg.signature);
       }
    });
