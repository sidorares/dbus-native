...
const debug        = require ('debug')('dbus-native:DBusInterfaceLibs')
...
class DBusInterface extends EventEmitter {
	...
	introspect (xmlRoot) {
		...
		let xml = xmlRoot.ele ('interface', {name: this._ifaceName})
...
/**
 * Used to "annotate" a {@link DBusInterface} and add a function to expose to the interface.
...
/**
 * Used to "annotate" a {@link DBusInterface} and add a property to expose to the interface.
 * @param {Object} ifaceClass - The DBusInterface class object to annotate
...
/**
 * Used to "annotate" a {@link DBusInterface} and add a signal to expose to the interface.
 * @param {Object} ifaceClass - The DBusInterface class object to annotate
