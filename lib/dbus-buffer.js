...
function convertLong(data) {
  var val = data.toNumber(); // convert to number (good up to 53 bits)
  ...
  return val; // Number is fine (or it's the only option)
}
