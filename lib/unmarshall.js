...
function read(bs, tree, callback)
{
    ...
    case 'a':
        ...
        align(bs, 2);
        bs.word32le('length').tap(function(vars) {
	    ...
	    bs.buffer('arrayBuffer', arrayBlobLength).tap(function(_vars) {
              //console.error(require('./hexy').hexy(_vars.arrayBuffer, {prefix: '===='}));
              var arrayBuffer = binary(_vars.arrayBuffer);
	      arrayBuffer.globalOffset = bs.globalOffset;
              return readArray(arrayBuffer, tree.child[0], function(err, value) {
